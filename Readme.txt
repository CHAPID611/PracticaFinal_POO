...
Vuelo:
Define los atributos y métodos generales para un vuelo.

VueloRegular:
Hereda de Vuelo y añade atributos específicos para vuelos regulares (como la aerolínea, el tipo de avión y los horarios).

VueloCharter: 
Hereda de Vuelo y añade atributos específicos para vuelos chárter (como la aerolínea, el paquete de viaje y la fecha).
